...
public class MaterialApplierWindow : EditorWindow
{
    ...
    private void UpdateTexture()
    {
        ...
        if (sourceTexture != null)
            texture = TextureUtility.GenerateTexture(res.x, res.y, mat, sourceTexture, format, linear);
        else
            texture = TextureUtility.GenerateTexture(res.x, res.y, mat, format, linear);
    }
}
