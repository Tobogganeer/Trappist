...
namespace Tobo.Net
{
    public class NetworkDiscoveryHUD : MonoBehaviour
    {
        ...
        string m_lookupServerPort = NetworkDiscovery.DefaultDiscoveryPort.ToString();
        ...
        void OnEnable()
        {
            m_networkDiscovery.OnServerDiscovered += OnDiscoveredServer;
        }
